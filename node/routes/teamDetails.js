...
router.get("/:id", (request, response) => {
  request
    .sql(
      // "SELECT t.id as 'team.Id', t.Name as 'team.Name', t.CreatedDate as 'team.CreatedDate',workorder.[Name] as [team.WorkOrder.Name], wos.[Name] as [team.WorkOrder.StatusName],  " +
      ...
      //   "where wo2.Id = workorder.Id and ei2.EquipmentID = e.Id for json path) as [team.EquipmentItems] " +
      ...
      //   "for json path)) as [team.Equipment] " +
      //   "FROM Team as t " +
